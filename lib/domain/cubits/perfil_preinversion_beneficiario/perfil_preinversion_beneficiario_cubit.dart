...
class PerfilPreInversionBeneficiarioCubit
  ...
  void changeConyugeNombre1(String? newValue) {
    final conyugeNombre1Changed = state.perfilPreInversionBeneficiario
        ?.copyWith(conyugeNombre1: newValue);
    emit(PerfilPreInversionBeneficiarioLoaded(conyugeNombre1Changed));
  }

  void changeConyugeNombre2(String? newValue) {
    final conyugeNombre2Changed = state.perfilPreInversionBeneficiario
        ?.copyWith(conyugeNombre2: newValue);
    emit(PerfilPreInversionBeneficiarioLoaded(conyugeNombre2Changed));
  }
  ...
  void changeConyugeApellido1(String? newValue) {
    ...
    emit(PerfilPreInversionBeneficiarioLoaded(conyugeApellido1Changed));
  }
  ...
  void changeConyugeApellido2(String? newValue) {
    ...
    emit(PerfilPreInversionBeneficiarioLoaded(conyugeApellido2Changed));
  }
  ...
  void changeAccesoExplotacionTierra(bool value) {
    ...
    emit(PerfilPreInversionBeneficiarioLoaded(accesoExplotacionTierraChanged));
  }
}
