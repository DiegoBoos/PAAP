class BeneficiarioPreinversionEntity {
  BeneficiarioPreinversionEntity({
  ...
  BeneficiarioPreinversionEntity copyWith({
    String? perfilPreInversionId,
    String? beneficiarioId,
    String? municipioId,
    String? veredaId,
  ...
  factory BeneficiarioPreinversionEntity.fromJson(Map<String, dynamic> json) =>
      BeneficiarioPreinversionEntity(
