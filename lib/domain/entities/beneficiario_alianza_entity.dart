class BeneficiarioAlianzaEntity {
  BeneficiarioAlianzaEntity({
  ...
  BeneficiarioAlianzaEntity copyWith({
    String? alianzaId,
    String? beneficiarioId,
    String? municipioId,
    String? veredaId,
  ...
  factory BeneficiarioAlianzaEntity.fromJson(Map<String, dynamic> json) =>
      BeneficiarioAlianzaEntity(
