...
abstract class AuthRemoteDataSource {
  Future<UsuarioModel> verificarUsuario(String usuarioId, String contrasena);
}
...
class AuthRemoteDataSourceImpl implements AuthRemoteDataSource {
  ...
  @override
  Future<UsuarioModel> verificarUsuario(
  ...
  Future<UsuarioModel> consultarUsuario(
    ...
    if (consultarUsuarioResp.statusCode == 200) {
      ...
      if (respuesta == 'true') {
        ...
        final usuario =
            usuarioModelFromJson(json.encode(decodedResp['objeto']));
