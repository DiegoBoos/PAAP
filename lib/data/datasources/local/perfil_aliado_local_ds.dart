...
class PerfilAliadoLocalDataSourceImpl implements PerfilAliadoLocalDataSource {
  ...
  Future<List<PerfilAliadoModel>> getPerfilAliadosDB(String perfilId) async {
    ...
    String sql = '''
      SELECT 
      PerfilAliado.PerfilId as PerfilId,
      PerfilAliado.AliadoId as AliadoId,
      PerfilAliado.ProductoId as ProductoId,
      PerfilAliado.VolumenCompra as VolumenCompra,
      PerfilAliado.UnidadId as UnidadId,
      PerfilAliado.FrecuenciaId as FrecuenciaId,
      PerfilAliado.PorcentajeCompra as PorcentajeCompra,
      PerfilAliado.SitioEntregaId as SitioEntregaId,
      Aliado.Nombre as Nombre,
      Aliado.FechaCreacion as FechaCreacion,
      Aliado.NombreContacto as NombreContacto,
      Aliado.Direccion as Direccion,
      Aliado.TelefonoFijo as TelefonoFijo,
      Aliado.TelefonoMovil as TelefonoMovil,
      Aliado.Correo as Correo,
      Aliado.MunicipioId as MunicipioId,
      Aliado.Experiencia as Experiencia,
      Aliado.FechaActivacion as FechaActivacion,
      Aliado.FechaDesactivacion as FechaDesactivacion,
      Aliado.FechaCambio as FechaCambio,
      Aliado.Activo as Activo,
      PerfilAliado.RecordStatus as RecordStatus
      FROM PerfilAliado
